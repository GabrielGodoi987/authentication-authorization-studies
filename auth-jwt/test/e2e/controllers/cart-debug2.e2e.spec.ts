...
// Monkey-patch the middleware to log
const origVerify = CartMiddleware.prototype.verifyToken;
CartMiddleware.prototype.verifyToken = async function (
  req: any,
  res: any,
  next: any,
) {
  ...
  return origVerify.call(this, req, res, next);
};
...
describe("Debug cart 500", () => {
  ...
  it("should debug add product", async () => {
    ...
    console.log("CART BODY:", JSON.stringify(cartRes.body));

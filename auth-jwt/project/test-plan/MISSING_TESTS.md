...
- [ ] `src/app.ts` - Configuração principal da aplicação
- [ ] `src/webserver/server.ts` - Inicialização do servidor

### 🗄️ Database Layer

- [ ] `src/database/source.ts` - Configuração da conexão com banco de dados
- [ ] `src/database/migrations/create-table-users.ts` - Migração: criação tabela usuários
- [ ] `src/database/migrations/1779670012718-create-table-products.ts` - Migração: criação tabela produtos
- [ ] `src/database/migrations/1779670052952-create-table-cart.ts` - Migração: criação tabela carrinho
- [ ] `src/database/migrations/1779670100000-create-table-cart-items.ts` - Migração: criação tabela itens do carrinho
- [ ] `src/database/seeds/main.ts` - Script principal de seeds
- [ ] `src/database/seeds/user.seed.ts` - Seed de usuários
- [ ] `src/database/seeds/cart.seed.ts` - Seed de carrinhos

### 📚 Documentation Layer

- [ ] `src/docs/swagger.ts` - Configuração do Swagger
- [ ] `src/docs/types.ts` - Tipos para documentação
...
- [ ] `src/lib/consts.ts` - Constantes da aplicação
...
**Total de arquivos sem testes: 41**
